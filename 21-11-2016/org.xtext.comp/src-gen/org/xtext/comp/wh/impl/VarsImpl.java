 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.comp.wh.impl.VarsImpl#getVars <em>Vars</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VarsImpl extends MinimalEObjectImpl.Container implements Vars
{
  ...
  public EList<String> getVars()
  {
    if (vars == null)
    {
      vars = new EDataTypeEList<String>(String.class, this, WhPackage.VARS__VARS);
    }
    return vars;
  }
